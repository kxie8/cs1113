...
set_eql (mkSet s) (mkSet a) = ite (eql s l) true false

-- Return a string representation of s
set_toString: (Serialize a) => set a -> String
set_toString (mkSet (v::nil)) = (toString v)
set_toString (mkSet nil) = ""
set_toString (mkSet (h::t)) = (toString h)++","++(set_toString t)
...
list_remove v (h::t) = ite (eql v h) (list_remove t) (h::(list_remove t))
...
-- Return the intersection of s1 and s2
-- set_intersection: (eq a) => (s1: set a) -> (s2: set a) -> set a
set_intersection (mkSet l1) (mkSet l2) = intersect l1 l2
...
list_difference (h::t) (h2::t2) = ite (eql h h2) (list_difference t (h2::t2)) (h::(list_difference t (h2::t2)))
...
help1: list a -> list b -> list (pair a b)
help1 (h::t) (h2::t2) = (mkPair h h2)::(help1 t t2)

set_product (mkSet la) (mkSet lb) = mkSet (help1 la lb)
